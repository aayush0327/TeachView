...
import com.example.techview.databinding.ActivityStudentTimeTableBinding;
...
public class HomePage extends AppCompatActivity {
    ...
    TextView day;
    String[] item = {"Dweepna Garg (DG)","Bhavika Patel (BNP)","Binal Kaka (BSK)","Chirag Patel (CIP)","Dhruvi Gosai (DDG)","Janardan Bharvad(JB)","Khushi Patel (KAP)","Kashyap Patel (KSP)","Kajal Parmar (KPP)","Dr.Minal Patel (MP)","Nisha Panchal (NAP)","Prassan Barot (PDB)","Sanjay Patel (SRP)","sachi Joshi (SVJ)","Shraddha Vyas (SPV)","Urvashi Chaudhari (UMC)"};
...
//        drawText = header.findViewById(R.id.drawText);
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                int a=(int)autoCompleteTextView.getAdapter().getCount();
                String str= (String) autoCompleteTextView.getAdapter().getItem(a);
//                Toast.makeText(HomePage.this, str, Toast.LENGTH_SHORT).show();
            }
        });
...
//                Toast.makeText(HomePage.this, "imageID", Toast.LENGTH_SHORT).show();
                    ...
                    storageReference.getFile(localfile)
                            .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Intent intent1=new Intent(HomePage.this,student_time_table.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(HomePage.this,option_class.class));
            }
        });
...
//                progressDialog.setCancelable(false);
//                progressDialog.show();
//                StorageReference   storageReference1 = FirebaseStorage.getInstance().getReference("class_timetable/"+"4CE-1"+".jpg");
//
//                try {
//                    File localfile = File.createTempFile("tempfile",".jpg");
...
//                                    byte[] byteArray = bStream.toByteArray();
//
//                                    Intent intent1=new Intent(HomePage.this,class_timetable.class);
//                                    intent1.putExtra("image", byteArray);
//                                    startActivity(intent1);
//
//
                   ...
                   storageReference1.getFile(localfile)
                           .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                               ...
                               public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                   ...
                                   Intent intent1=new Intent(HomePage.this,vacant_class.class);
                                   intent1.putExtra("image", byteArray);
                                   startActivity(intent1);
                    ...
                    storageReference1.getFile(localfile)
                            .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Intent intent1=new Intent(HomePage.this,vacant_Lab.class);
                                    intent1.putExtra("image", byteArray);
                                    startActivity(intent1);
       ...
       textViewDate.setText(currentDate);
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(HomePage.this, "faculty"+item, Toast.LENGTH_SHORT).show();
            }
        });
